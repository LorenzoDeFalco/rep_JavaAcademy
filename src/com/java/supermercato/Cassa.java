...
public class Cassa {
	...
	public FileReader stampaScontrino(Scontrino scon) throws IOException
	{
		FileWriter fpW = new FileWriter("Scontrino.txt");
		
		fpW.write(scon.stampaScontrino());
		
		fpW.close();
		return new FileReader("Scontrino.txt");
	}
